						...
						<tr class="row_<?php echo $key->id ?>">
							...
							<td class="textR">
								...
								<td class="option textC">
									...
									<a href="<?php echo admin_url('product/detail/'.$key->id) ?>" class="tipS" title="Xem chi tiết sản phẩm">
									...
									<a href="<?php echo admin_url('product/del/'.$key->id) ?>" title="Xóa" class="tipS verify_action">
