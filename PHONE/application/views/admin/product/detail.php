...
<div class="wrapper">
	...
	<!-- Form -->
	<form enctype="multipart/form-data" method="post" action="<?php echo admin_url() ?>" id="form" class="form">
		<fieldset>
			<div class="widget">
				<div class="title">
					<img class="titleIcon" src="<?php echo public_url('admin')?>/images/icons/dark/add.png">
					<h6>Xem chi tiết Sản phẩm</h6>
				</div>
				...
				<div class="tab_container">
					<div class="tab_content pd0" id="tab1" style="display: block;">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" value="<?php echo $product->total?>" _autocheck="true" class="format_number" id="param_price" style="width:100px" name="price">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" value="<?php echo $product->buyed?>" _autocheck="true" class="format_number" id="param_price" style="width:100px" name="price">
								...
								<select name="catalog"_autocheck="true" id="param_cat" class="left"><!-- đặt tên biến select để biết tên biến dữ liệu sẽ gửi lên  -->
									...
									<?php foreach ($catalogs as $key): ?>
										<?php if($key->subs > 1): ?>
											...
											<?php else: ?>
												<option value="<?php echo $key->id ?>"<?php if($row->id == $product->catalog_id) echo 'selected';?>><?php echo $key->name ?></option>
											<?php endif; ?>	
										<?php endforeach; ?>							
									</select>
					...
					<div class="formSubmit">
						<input type="submit" class="redB" value="Về trang chủ">
